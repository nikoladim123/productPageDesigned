...
function mmnavPcolorChange(e) {
  for (var i = 0; i < mmnavHoverButtons.length; i++) {
    mmnavHoverButtons[i].style.background = 'transparent';
    mmnavHoverButtons[i].style.color = '#a4a4a4';
  }
